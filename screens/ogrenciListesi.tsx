...
const styles = StyleSheet.create({
    ...
    header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 6, backgroundColor: 'white', borderBottomWidth: 1, borderBottomColor: '#ddd' },
    toggleButton: { padding: 10, backgroundColor: '#e0e0e0', borderRadius: 20 },
    toggleButtonActive: { backgroundColor: '#4CAF50' },
    toggleButtonText: { color: '#333', fontSize: 10, fontWeight: 'bold' },
    ...
    addButton: { backgroundColor: '#f01394ff', padding: 10, borderRadius: 20, marginTop: 0, marginBottom: 50 },
